...
public class LevelScreenCandyland extends BaseScreen{
    Player band;
    ...
    public void initialize() {        
        ...
        TilemapActor tma = new TilemapActor("assets/MapaCandyland.tmx", mainStage);
        ...
        coinSound.setVolume(0, volumenEfecto);
        fireballSound.setVolume(0, volumenEfecto);
        daño.setVolume(0, volumenEfecto);
        estrella.setVolume(0, volumenEfecto);
        vidaMas.setVolume(0, volumenEfecto);
        
        music = Gdx.audio.newMusic(Gdx.files.internal("assets/Balloon Game.mp3"));
        ...
        for (MapObject obj : tma.getTileList("Enemy1Choco") ){
        	
            MapProperties props = obj.getProperties();
            new Enemy1Choco( (float)props.get("x"), (float)props.get("y"), mainStage );
        }
   ...
   /*     for (BaseActor timer : BaseActor.getList(mainStage, "Timer")){
        ...
        for (BaseActor actor : BaseActor.getList(mainStage, "Solid")){
             ...
             */
            for (BaseActor enemy1 : BaseActor.getList(mainStage, "Enemy1Choco")){
            ...
            /**
             * Colisiones del Enemigo8 con el Suelo
             */
          for (BaseActor enemy8 : BaseActor.getList(mainStage, "Enemy8")){
                ...
                if (enemy8.overlaps(solid)){
		        	...
		        	if(enemy8.velocityVec.x > 0) {
		        		enemy8.velocityVec.x = -(MathUtils.random(20,35));
		        		enemy8.setScaleX(1);
        ...
        /**
         * Colision del Enemigo8 y el Enemigo1
         */
        for (BaseActor enemy8 : BaseActor.getList(mainStage, "Enemy8")){    

            for (BaseActor enemy1 : BaseActor.getList(mainStage, "Enemy1Choco")){
            	
            	if(enemy8.overlaps(enemy1)){
