...
public class TilemapActor extends Actor {
    ...
    public static int windowWidth  = 1280 ; //800 //1240 //1600 peta
    public static int windowHeight = 720;  //460 //800 //900 peta
    ...
    public TilemapActor(String filename, Stage theStage){
    	...
    	windowWidth = MenuScreenCamara.getResolucionX();
    	windowHeight = MenuScreenCamara.getResolucionY();
        ...
        tiledCamera.setToOrtho(false, windowWidth*2, windowHeight*2);
        tiledCamera.update();
