...
public class MenuScreenPersonajesDemo extends BaseScreen{
	...
	public void initialize() {
		...
		TextButton button5 = new TextButton("Amarillo", style);
		...
		uiTable.row();
		uiTable.add(button5).center().width(250).height(120).pad(5);
