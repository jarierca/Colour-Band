...
public class LevelScreenDemo extends BaseScreen{
    Player band;
    ...
    public void initialize() {     
        ...
        TilemapActor tma = new TilemapActor("assets/MapaDemo.tmx", mainStage);
   ...
   /*     keyTable = new Table();
       ...
       // uiTable.add(timeLabel);
        uiTable.row();
        uiTable.add().colspan(11).expandY();
   ...
   /*     for (BaseActor timer : BaseActor.getList(mainStage, "Timer")){
      ...
      /*      for (BaseActor enemy9 : BaseActor.getList(mainStage, "Enemy9")){
                ...
                if (enemy9.overlaps(solid)){
                	
                	enemy9.preventOverlap(solid);
                	//enemy9.setMotionAngle( band.getMotionAngle() );
                	
                	Vector2 bandPosition  = new Vector2(  band.getX(),  band.getY() );
                   // enemy9.setMotionAngle(bandPosition.angle());
                	
                	enemy9.setPosition(band.getX(),  band.getY(), 1);
                }
            }*/
            /**
        ...
        for (BaseActor muerte : BaseActor.getList(mainStage, "Muerte")){
            ...
            if ( band.overlaps(muerte)) {  
            	music.pause();        	
            	ColourBand.setActiveScreen( new LevelScreenDemo());
            }  
        }
        /**
